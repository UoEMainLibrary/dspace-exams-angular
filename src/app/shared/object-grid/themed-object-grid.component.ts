...
export class ThemedObjectGridComponent extends ThemedComponent<any> implements OnInit {
/**
...
columns$: Observable<ListableObject[]>;
  ...
  */
  ...
  protected importThemedComponent(themeName: string): Promise<any> {
    return import(`../../../themes/${themeName}/app/shared/object-grid/object-grid.component`);
  }

  protected importUnthemedComponent(): Promise<any> {
    return import('./object-grid.component');
  }
